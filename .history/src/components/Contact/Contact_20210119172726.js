...
const Contact = () => {
  ...
  const formValidation = () => {
    ...
    if (formState.name === "") {
      ...
      handleFieldError("nameError", null)
      // hasNameError = false
    }
    ...
    if (!emailValid) {
      ...
      handleFieldError("emailError", null)
      // hasEmailError = false
    }
    ...
    if (formState.message === "") {
      ...
      handleFieldError("messageError", null)
      // hasMessageError = false
    }

    if (
      formState.nameError.length ||
      formState.emailError.length ||
      formState.messageError.length
    ) {
      setDisabled(true)
      console.log("errors")
    } else {
